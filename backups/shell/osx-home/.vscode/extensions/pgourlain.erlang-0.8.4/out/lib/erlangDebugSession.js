...
class ConditionalBreakpoint {
    constructor(condition, hitCondition, logMessage) {
...
class ErlangDebugSession extends vscode_debugadapter_1.DebugSession {
    ...
    resolveExtensionPath() {
        ...
        if (((_a = process.argv) === null || _a === void 0 ? void 0 : _a.length) > 0) {
            if (!path.isAbsolute(erlangConnection_1.erlangBridgePath)) {
                ...
                erlangConnection_1.setExtensionPath(extPath);
            }
        }
    }
    ...
    conditionalBreakpointHit(cbp, processName, module, line, sp, thid) {
    ...
    handleBracesInLogMessage(processName, sp, str) {
